"use strict";
/* === fix2 v19.1 : échelle couronne propre (fin des pertes longues) === */
Tracker.prototype.update=function(dets,merges){
  ...
  if(dets.length===NB_ROIS){
    ...
    for(let[c,t,d]of pairs){
      if(done.has(t)||uD.has(d)||!okS(d)||!okY(d))continue;
...
let bk6=$("#jsok");
if(bk6){bk6.textContent="✅ JS v19.1 (échelle couronne corrigée)";bk6.style.color="#69f0ae";}
